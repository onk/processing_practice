class SeparateBox {
  ...
  SeparateBox(int x, int y, int z, PImage img) {
    ...
    texes[1] = img.get((6-x)*(BOX_SIZE+DISTANCE_SIZE)/2, y*(BOX_SIZE+DISTANCE_SIZE)/2, BOX_SIZE/2, BOX_SIZE/2);
    texes[2] = img.get(x*(BOX_SIZE+DISTANCE_SIZE)/2, (6-z)*(BOX_SIZE+DISTANCE_SIZE)/2, BOX_SIZE/2, BOX_SIZE/2);
    texes[3] = img.get(x*(BOX_SIZE+DISTANCE_SIZE)/2, z*(BOX_SIZE+DISTANCE_SIZE)/2, BOX_SIZE/2, BOX_SIZE/2);
    texes[4] = img.get((6-z)*(BOX_SIZE+DISTANCE_SIZE)/2, y*(BOX_SIZE+DISTANCE_SIZE)/2, BOX_SIZE/2, BOX_SIZE/2);
